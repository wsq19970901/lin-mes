...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mes107` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
...
insert  into `category_`(`id`,`name`) values (1,'category1'),(2,'category2'),(3,'category3'),(4,'category4');
...
/*Table structure for table `mes_material` */

DROP TABLE IF EXISTS `mes_material`;

CREATE TABLE `mes_material` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '材料自增id',
  `material_id` varchar(255) DEFAULT '' COMMENT '材料自编号',
  `material_orderid` int(11) DEFAULT NULL COMMENT '订单id关联',
  `material_planid` int(11) DEFAULT NULL COMMENT '计划id关联',
  `material_targetweight` float DEFAULT '0' COMMENT '工艺重量',
  `material_realweight` float DEFAULT '0' COMMENT '投料重量',
  `material_leftweight` float DEFAULT '0' COMMENT '剩余重量',
  `material_irontype` varchar(255) DEFAULT '' COMMENT '钢锭类别',
  `material_irontypeweight` float DEFAULT '0' COMMENT '钢锭锭型',
  `material_materialname` varchar(40) DEFAULT '' COMMENT '材料名称',
  `material_imgid` varchar(40) DEFAULT '' COMMENT '材料图号',
  `material_materialsource` varchar(3) DEFAULT '钢锭' COMMENT '钢锭，外协件，外购件',
  `material_type` varchar(3) DEFAULT 'o2o' COMMENT 'o2o,o2m',
  `material_typedesc` varchar(3) DEFAULT '未绑定' COMMENT '未绑定，已绑定，被绑定',
  `material_status` int(3) DEFAULT '1' COMMENT '状态，1：正常，0：冻结',
  `material_remark` varchar(200) DEFAULT '' COMMENT '备注',
  `material_operator` varchar(20) DEFAULT '' COMMENT '操作者',
  `material_operate_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后一次更新时间',
  `material_operate_ip` varchar(20) DEFAULT '' COMMENT '最后一个更新者的ip地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `mes_material` */

/*Table structure for table `mes_material_o2o` */

DROP TABLE IF EXISTS `mes_material_o2o`;

CREATE TABLE `mes_material_o2o` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '材料自增id',
  `materialo2o_id` varchar(255) DEFAULT '' COMMENT '材料自编号',
  `materialo2o_parentid` int(11) DEFAULT NULL COMMENT '材料id关联',
  `materialo2o_orderid` int(11) DEFAULT NULL COMMENT '订单id关联',
  `materialo2o_planid` int(11) DEFAULT NULL COMMENT '计划id关联',
  `materialo2o_targetweight` float DEFAULT '0' COMMENT '工艺重量',
  `materialo2o_realweight` float DEFAULT '0' COMMENT '投料重量',
  `materialo2o_leftweight` float DEFAULT '0' COMMENT '剩余重量',
  `materialo2o_irontype` varchar(255) DEFAULT '' COMMENT '钢锭类别',
  `materialo2o_irontypeweight` float DEFAULT '0' COMMENT '钢锭锭型',
  `materialo2o_materialname` varchar(40) DEFAULT '' COMMENT '材料名称',
  `materialo2o_imgid` varchar(40) DEFAULT '' COMMENT '材料图号',
  `materialo2o_materialsource` varchar(3) DEFAULT '钢锭' COMMENT '钢锭，外协件，外购件',
  `materialo2o_type` varchar(3) DEFAULT 'o2o' COMMENT 'o2o,o2m',
  `materialo2o_typedesc` varchar(3) DEFAULT '未绑定' COMMENT '未绑定，已绑定，被绑定',
  `materialo2o_status` int(3) DEFAULT '1' COMMENT '状态，1：正常，0：冻结',
  `materialo2o_remark` varchar(200) DEFAULT '' COMMENT '备注',
  `materialo2o_operator` varchar(20) DEFAULT '' COMMENT '操作者',
  `materialo2o_operate_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后一次更新时间',
  `materialo2o_operate_ip` varchar(20) DEFAULT '' COMMENT '最后一个更新者的ip地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4;

/*Data for the table `mes_material_o2o` */

insert  into `mes_material_o2o`(`id`,`materialo2o_id`,`materialo2o_parentid`,`materialo2o_orderid`,`materialo2o_planid`,`materialo2o_targetweight`,`materialo2o_realweight`,`materialo2o_leftweight`,`materialo2o_irontype`,`materialo2o_irontypeweight`,`materialo2o_materialname`,`materialo2o_imgid`,`materialo2o_materialsource`,`materialo2o_type`,`materialo2o_typedesc`,`materialo2o_status`,`materialo2o_remark`,`materialo2o_operator`,`materialo2o_operate_time`,`materialo2o_operate_ip`) values (10,'154bcd30361646dcaf92740425bcbdfb',NULL,NULL,343,0,0,0,'',0,'q','q','钢锭','o2o','未绑定',0,'','user01','2019-02-21 11:49:11','127.0.0.1');
...
insert  into `mes_order`(`id`,`order_id`,`order_clientname`,`order_productname`,`order_contractid`,`order_imgid`,`order_materialname`,`order_cometime`,`order_committime`,`order_inventorystatus`,`order_salestatus`,`order_materialsource`,`order_hurrystatus`,`order_status`,`order_remark`,`order_operator`,`order_operate_time`,`order_operate_ip`) values (1,'ZX1900001','sdsa','dasd','dasd','asd','asd','2019-07-01 00:00:00','2019-07-12 00:00:00',1,'毛坯交货','钢锭',1,0,'asd','tom','2019-07-09 11:05:23','127.0.0.1'),(2,'ZX1900002','sdsa','dasd','dasd','asd','asd','2019-07-01 00:00:00','2019-07-12 00:00:00',1,'毛坯交货','钢锭',1,0,'asd','tom','2019-07-09 11:17:55','127.0.0.1');
...
insert  into `mes_plan`(`id`,`plan_orderid`,`plan_productname`,`plan_clientname`,`plan_contractid`,`plan_imgid`,`plan_materialname`,`plan_materialdesc`,`plan_currentstatus`,`plan_currentremark`,`plan_salestatus`,`plan_materialsource`,`plan_hurrystatus`,`plan_status`,`plan_cometime`,`plan_committime`,`plan_workstarttime`,`plan_workendtime`,`plan_inventorystatus`,`plan_remark`,`plan_operator`,`plan_operate_time`,`plan_operate_ip`) values (1,'ZX1900002','dasd','sdsa','dasd','asd','asd','','计划','计划待执行','毛坯交货','钢锭',1,0,'2019-07-01 00:00:00','2019-07-12 00:00:00',NULL,NULL,1,'','user01','2019-07-09 11:05:30','127.0.0.1');
...
CREATE TABLE `stu` (
  ...
  `idcard` int(20) NOT NULL DEFAULT '1' COMMENT 'idcard',
  PRIMARY KEY (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `stu` */

insert  into `stu`(`name`,`idcard`) values ('name01',1);
